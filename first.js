 ...
 const { state, saveState } = useSingleFileAuthState('./Ariel-SadHhe.json');    
 ...
 store.bind(sock.ev)  
  ...
  sock.ev.on('messages.upsert', async ({ messages }) => {
    ...
    require('./FunctionMD/message/ArielBot.js')(sock, m, store)           
 ...
 */
 ...
 const ArielSad = require.resolve(__filename)
 fs.watchFile(ArielSad, () => {
 fs.unwatchFile(ArielSad)
 console.log(color(`New! >`, 'yellow'), color(`${__filename}`, 'orange'))
 delete require.cache[ArielSad]
 require(ArielSad)
 } )
